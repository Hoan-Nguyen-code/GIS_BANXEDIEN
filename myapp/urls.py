...
urlpatterns = [
    ...
    path('dashboard/kho/export-in/', admin_views.export_stock_in, name='export_stock_in'),
    path('dashboard/kho/export-out/', admin_views.export_stock_out, name='export_stock_out'),
